// =============================================================================
// FICHIER : controllers/accountingController.js (VERSION RESTAURÉE INTÉGRALE)
// =============================================================================
...
/**
 * 2. REPORTING SYSCOHADA ET TABLEAU DE BORD
 */
...
exports.createJournalEntry = async (req, res) => {
    try {
        ...
        if (!result || result.status === 'error') throw new Error(result ? result.message : "Erreur Odoo");
