...
const RESULTAT_MAPPING = [
    ...
    { ref: 'TI', libelle: "Transferts de charges d'exploitation", sens: '+', note: '12', comptes: ['781'], type: 'produit' },
    ...
    { ref: 'TJ', libelle: "Reprises d'amortissements, provisions et dépréciations", sens: '+', note: '28', comptes: ['79'], type: 'produit' },
    ...
    { ref: 'RQ', libelle: 'Participation des travailleurs', sens: '-', note: '30', comptes: ['87'], type: 'charge' },
