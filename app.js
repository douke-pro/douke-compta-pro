...
<title>DOUKÈ Compta Pro - Cabinet Comptable SYSCOHADA</title>
...
<div class="w-16 h-16 bg-primary text-white rounded-full mx-auto mb-4 flex items-center justify-center">
<i class="fas fa-calculator text-2xl"></i>
</div>
<h1 class="text-2xl font-bold text-gray-900 dark:text-white">DOUKÈ Compta Pro</h1>
<p class="text-gray-600 dark:text-gray-400 mt-2">Système de Gestion Comptable SYSCOHADA</p>
</div>
...
<button type="submit" class="w-full bg-primary hover:bg-primary-light text-white font-semibold py-3 rounded-lg transition-colors">
...
<i class="fas fa-users mr-2 text-info"></i>Comptes de démonstration
</h3>
<div class="grid grid-cols-2 gap-2 text-xs">
<button onclick="fillCredentials('admin')" class="p-2 bg-primary/10 text-primary rounded hover:bg-primary/20">
👨‍💼 Admin
</button>
<button onclick="fillCredentials('collaborateur-senior')" class="p-2 bg-info/10 text-info rounded hover:bg-info/20">
👩‍💼 Collab. Senior
</button>
<button onclick="fillCredentials('collaborateur')" class="p-2 bg-success/10 text-success rounded hover:bg-success/20">
👨‍💻 Collaborateur
</button>
<button onclick="fillCredentials('user')" class="p-2 bg-warning/10 text-warning rounded hover:bg-warning/20">
👤 Utilisateur
</button>
<button onclick="fillCredentials('caissier')" class="p-2 bg-gray-500/10 text-gray-700 dark:text-gray-300 rounded hover:bg-gray-500/20">
🏪 Caissier
</button>
</div>
</div>
...
<p class="text-sm text-gray-600 dark:text-gray-400">SYSCOHADA Révisé</p>
</div>
</div>
...
<select id="activeCompanySelect" onchange="selectCompany(this.value)"
...
<div class="text-sm font-medium text-gray-900 dark:text-white" id="currentUserName">Utilisateur</div>
<div class="text-xs text-gray-500 dark:text-gray-400" id="currentUserRole">Role</div>
</div>

<!-- Bouton déconnexion -->
<button onclick="logout()" class="text-danger hover:text-danger/80 p-2" title="Déconnexion">
...
<!-- Sidebar Navigation -->
<nav class="w-64 bg-white dark:bg-gray-800 shadow-lg border-r border-gray-200 dark:border-gray-700">
<div class="p-6">
<div class="text-center mb-6">
<div class="w-12 h-12 bg-primary text-white rounded-full mx-auto mb-2 flex items-center justify-center">
<span id="userInitials" class="font-semibold">U</span>
</div>
<div class="text-sm font-medium text-gray-900 dark:text-white" id="sidebarUserName">Utilisateur</div>
<div class="text-xs text-gray-500 dark:text-gray-400" id="sidebarUserProfile">Profile</div>
</div>

<!-- Entreprise sélectionnée -->
<div class="mb-6 p-3 bg-primary/10 rounded-lg">
<div class="text-xs text-primary font-medium mb-1">Entreprise active</div>
<div class="text-sm font-semibold text-gray-900 dark:text-white" id="currentCompany">
Aucune entreprise sélectionnée
</div>
<div class="text-xs text-gray-500 dark:text-gray-400" id="selectedCompanyInfo"></div>
</div>
</div>

<!-- Menu Navigation -->
<div id="navigationMenu" class="space-y-1">
...
<div id="userModal" class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
<div class="flex justify-between items-center mb-6">
<h2 class="text-xl font-bold text-gray-900 dark:text-white" id="userModalTitle">Nouveau Collaborateur</h2>
...
<div id="companiesCheckboxes" class="grid grid-cols-2 gap-2 max-h-32 overflow-y-auto border border-gray-300 dark:border-gray-600 rounded-lg p-3 bg-gray-50 dark:bg-gray-700">
...
<span id="userFormSubmitText">Créer</span>
</button>
</div>
</form>
</div>
...
<div id="companyModal" class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 w-full max-w-2xl">
<div class="flex justify-between items-center mb-6">
<h2 class="text-xl font-bold text-gray-900 dark:text-white" id="companyModalTitle">Nouvelle Entreprise</h2>
<button onclick="closeModal('companyModal')" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
<i class="fas fa-times text-xl"></i>
</button>
</div>
...
<select id="companySystem" required
class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg
bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-base">
<option value="">Sélectionner</option>
...
<input type="number" id="companyCashRegisters" min="1" max="10" value="1"
class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg
bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-base">
</div>
<div>
...
<button type="submit"
class="px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors">
<span id="companyFormSubmitText">Créer</span>
</button>
</div>
</form>
</div>
...
<div id="entryModal" class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
<div class="flex justify-between items-center mb-6">
<h2 class="text-xl font-bold text-gray-900 dark:text-white" id="entryModalTitle">Nouvelle Écriture</h2>
<button onclick="closeModal('entryModal')" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
<i class="fas fa-times text-xl"></i>
</button>
</div>
...
<select id="entryJournal" required onchange="generatePieceNumber()"
class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg
bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-base">
<option value="">Sélectionner</option>
...
<h3 class="text-lg font-semibold text-gray-900 dark:text-white">Lignes d'écriture</h3>
<button type="button" onclick="addEntryLine()"
class="bg-success text-white px-3 py-1 rounded text-sm hover:bg-success/90 transition-colors">
...
<div class="mt-4 flex justify-end space-x-4 text-sm font-medium">
<span class="text-gray-600 dark:text-gray-400">Total Débit: <span id="totalDebit" class="text-primary">0</span> FCFA</span>
<span class="text-gray-600 dark:text-gray-400">Total Crédit: <span id="totalCredit" class="text-success">0</span> FCFA</span>
<span class="text-gray-600 dark:text-gray-400">Différence: <span id="totalDifference" class="text-danger">0</span> FCFA</span>
</div>
</div>

<div class="flex justify-end space-x-3">
<button type="button" onclick="closeModal('entryModal')"
class="px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-colors">
Annuler
</button>
<button type="submit"
class="px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors">
<span id="entryFormSubmitText">Enregistrer</span>
</button>
</div>
</form>
</div>
...
<div id="accountModal" class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 w-full max-w-lg">
<div class="flex justify-between items-center mb-6">
<h2 class="text-xl font-bold text-gray-900 dark:text-white" id="accountModalTitle">Nouveau Compte</h2>
...
class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg
bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-base font-mono">
<p class="text-xs text-gray-500 dark:text-gray-400 mt-1">6 chiffres (ex: 411000)</p>
</div>
<div>
...
<select id="accountClass" required
class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg
bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-base">
<option value="">Sélectionner</option>
...
<option value="9">Classe 9 - Comptabilité analytique</option>
</select>
</div>
</div>
...
<button type="submit"
class="px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors">
<span id="accountFormSubmitText">Créer</span>
</button>
</div>
</form>
</div>
...
<div id="cashModal" class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 w-full max-w-lg">
<div class="flex justify-between items-center mb-6">
<h2 class="text-xl font-bold text-gray-900 dark:text-white" id="cashModalTitle">Nouvelle Caisse</h2>
<button onclick="closeModal('cashModal')" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
<i class="fas fa-times text-xl"></i>
</button>
</div>
...
<input type="number" id="cashBalance" required min="0" step="1"
class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg
bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-base">
</div>
<div>
<label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Statut</label>
<select id="cashStatus" required
class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg
bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-base">
<option value="">Sélectionner</option>
...
<div class="flex justify-end space-x-3 mt-6">
<button type="button" onclick="closeModal('cashModal')"
class="px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-colors">
Annuler
</button>
<button type="submit"
class="px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors">
<span id="cashFormSubmitText">Créer</span>
</button>
</div>
</form>
</div>
...
<script>
// =============================================================================
// DOUKÈ Compta Pro - Application Principal (Version Complète Fonctionnelle)
// =============================================================================
...
console.log('🔧 Application DOUKÈ Compta Pro - Version complète fonctionnelle chargée');
</script>
