// =============================================================================
// FICHIER : middleware/auth.js (VERSION V19 - CORRIGÉ DOUBLON + NOM ÉMETTEUR)
// ✅ CORRECTION : Suppression du doublon const jwt / protect / module.exports
// ✅ AJOUT     : name extrait du token JWT dans protect
// =============================================================================
...
const protect = async (req, res, next) => {
    try {
        ...
        // ✅ name extrait du token pour afficher le vrai émetteur
        req.user = {
...
// =============================================================================
// EXPORT — un seul module.exports, rien après
// =============================================================================
