...
// Description : Logique frontend de l'application Doukè Compta Pro
// =================================================================================

// 🛑 NOUVELLE SOLUTION ROBUSTE : DÉTECTION AUTOMATIQUE DE L'ENVIRONNEMENT (CORRECTION CRITIQUE)
let API_BASE_URL;

// On utilise l'environnement Codespaces comme référence pour l'URL dynamique
if (window.location.host.includes('codespaces.github.dev') || window.location.host.endsWith('-3000.app.github.dev')) {
    // Dans Codespaces, on construit l'URL à partir de l'hôte actuel (HTTPS)
    ...
    // Si nous sommes en local, on conserve localhost:3000
    API_BASE_URL = 'http://localhost:3000/api';

    // RAPPEL : Pour que la connexion fonctionne en local, le serveur (node server.js) doit tourner.
...
async function handleLogin(event) {
    ...
    try {
        ...
        // C'est ici que l'ancien message d'erreur était généré.
        // Maintenant, l'API_BASE_URL est dynamique, donc le serveur devrait être joint.
