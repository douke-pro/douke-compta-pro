// =============================================================================
// DOUKÈ Compta Pro - Gestionnaire de thèmes v3.1
// =============================================================================
...
const themeManager = {
    ...
    init() {
        ...
        console.log('✅ Thème initial:', this.current);
    },
    ...
    try {
        ...
        if (window.unifiedManager && window.unifiedManager.notificationManager) {
            window.unifiedManager.notificationManager.show(
                'success', 
                'Thème modifié', 
                `Thème ${theme} appliqué avec succès`
            );
        }
    } catch (error) {
...
console.log('📦 Module ThemeManager chargé');
